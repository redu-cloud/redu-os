...
COLLECTOR_API_KEY=AUTO_GENERATE
...
if [ "${COLLECTOR_API_KEY:-AUTO_GENERATE}" = "AUTO_GENERATE" ] || [ "${COLLECTOR_API_KEY:-}" = "change-me-please" ] || [ -z "${COLLECTOR_API_KEY:-}" ]; then
  COLLECTOR_API_KEY="$(generate_hex 32)"
fi
